...
// node_modules/vue-blox-mustache/dist/vue-blox-mustache.es.js
var c = __toESM(require_mustache());
var h = class {
  run(r, e, n, u, t) {
    const o = this.runMustache(e, n, 0, 10);
    u(r, o);
  }
  runMustache(r, e, n = 0, u = 10) {
    if (typeof r != "string" || !r.includes("{{"))
      return r;
    try {
      let t = c.render(r, e);
      return t.includes("{{") && n < 10 && (t = this.runMustache(t, e, n + 1)), t;
    } catch (t) {
      throw new B(
        "Mustache parsing failed.",
        `The call to runMustache() for value ${r} threw the error: ${t}`,
        void 0
      );
    }
  }
...
export {
  h as BloxPluginMustache,
  l as getPluginMustache
};
//# sourceMappingURL=vue-blox-mustache.js.map
